...
public class CodingAssignment extends ExtentTestNGITestListener  {
	...
	public static String getAccessToken() {
		...
		resourceDetails.setUsername("testforibusiness@ibusiness.in");
		resourceDetails.setPassword("Test@123");
		resourceDetails.setAccessTokenUri(GENERATE_TOKEN_URL);
		resourceDetails
				.setClientId("3MVG9fe4g9fhX0E5qgtfiN3DaF2W..oTppSVm3aQseMPrMG1rR0ie5_Q.pOx7TuLFvaG1dJN1cFTQvboyZobT");
		resourceDetails.setClientSecret("AA94756377125E3FA965C0C2B91290A55E852B53E401CFBD46BBCEBDABB1B3F3");
	...
	public static String createAccount(String accessToken) {
		...
		verifySchema(response, "./Schemas/createAccount.json");
